...
private static WPI_TalonSRX winchMotor;
    ...
    public Climb() {
        ...
        buddyWinchBack = new WPI_VictorSPX(10);//15

        buddyWinchFront = new WPI_VictorSPX(12);

        hookMotor = new WPI_TalonSRX(15);//10
    ...
    // lowering robot or untangling cord. Winch must be set the right way to turn
    // right.
    ...
    public void deployBuddyNet (){
        buddyNetPiston.set(true); //ask if it will go 
        //Timer.delay(5);
        //buddyNetPiston.set(false);
    }
}
